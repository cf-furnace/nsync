...
type FakeReplicationController struct {
	CreateStub        func(*v1.ReplicationController) (*v1.ReplicationController, error)
	createMutex       sync.RWMutex
	createArgsForCall []struct {
		arg1 *v1.ReplicationController
	}
	createReturns struct {
		result1 *v1.ReplicationController
		result2 error
	}
	UpdateStub        func(*v1.ReplicationController) (*v1.ReplicationController, error)
	...
	UpdateStatusStub        func(*v1.ReplicationController) (*v1.ReplicationController, error)
	...
	GetStub        func(name string) (*v1.ReplicationController, error)
	...
	ListStub        func(opts api.ListOptions) (*v1.ReplicationControllerList, error)
	listMutex       sync.RWMutex
	listArgsForCall []struct {
		opts api.ListOptions
	}
	listReturns struct {
		result1 *v1.ReplicationControllerList
		result2 error
	}
...
func (fake *FakeReplicationController) Create(arg1 *v1.ReplicationController) (*v1.ReplicationController, error) {
...
func (fake *FakeReplicationController) CreateArgsForCall(i int) *v1.ReplicationController {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
	return fake.createArgsForCall[i].arg1
}

func (fake *FakeReplicationController) CreateReturns(result1 *v1.ReplicationController, result2 error) {
	fake.CreateStub = nil
...
func (fake *FakeReplicationController) Update(arg1 *v1.ReplicationController) (*v1.ReplicationController, error) {
...
func (fake *FakeReplicationController) UpdateArgsForCall(i int) *v1.ReplicationController {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
	return fake.updateArgsForCall[i].arg1
}

func (fake *FakeReplicationController) UpdateReturns(result1 *v1.ReplicationController, result2 error) {
	fake.UpdateStub = nil
...
func (fake *FakeReplicationController) UpdateStatus(arg1 *v1.ReplicationController) (*v1.ReplicationController, error) {
...
func (fake *FakeReplicationController) UpdateStatusArgsForCall(i int) *v1.ReplicationController {
	fake.updateStatusMutex.RLock()
	defer fake.updateStatusMutex.RUnlock()
	return fake.updateStatusArgsForCall[i].arg1
}

func (fake *FakeReplicationController) UpdateStatusReturns(result1 *v1.ReplicationController, result2 error) {
...
func (fake *FakeReplicationController) Get(name string) (*v1.ReplicationController, error) {
	fake.getMutex.Lock()
...
func (fake *FakeReplicationController) GetReturns(result1 *v1.ReplicationController, result2 error) {
	fake.GetStub = nil
...
func (fake *FakeReplicationController) List(opts api.ListOptions) (*v1.ReplicationControllerList, error) {
	fake.listMutex.Lock()
...
func (fake *FakeReplicationController) ListReturns(result1 *v1.ReplicationControllerList, result2 error) {
	fake.ListStub = nil
