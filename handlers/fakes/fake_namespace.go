...
type FakeNamespace struct {
	...
	GetStub        func(name string) (*v1.Namespace, error)
	...
	ListStub        func(opts api.ListOptions) (*v1.NamespaceList, error)
...
func (fake *FakeNamespace) Create(arg1 *v1.Namespace) (*v1.Namespace, error) {
...
func (fake *FakeNamespace) CreateArgsForCall(i int) *v1.Namespace {
	fake.createMutex.RLock()
	defer fake.createMutex.RUnlock()
	return fake.createArgsForCall[i].arg1
}

func (fake *FakeNamespace) CreateReturns(result1 *v1.Namespace, result2 error) {
	fake.CreateStub = nil
...
func (fake *FakeNamespace) Update(arg1 *v1.Namespace) (*v1.Namespace, error) {
...
func (fake *FakeNamespace) UpdateArgsForCall(i int) *v1.Namespace {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
	return fake.updateArgsForCall[i].arg1
}

func (fake *FakeNamespace) UpdateReturns(result1 *v1.Namespace, result2 error) {
	fake.UpdateStub = nil
...
func (fake *FakeNamespace) UpdateStatus(arg1 *v1.Namespace) (*v1.Namespace, error) {
...
func (fake *FakeNamespace) UpdateStatusArgsForCall(i int) *v1.Namespace {
	fake.updateStatusMutex.RLock()
	defer fake.updateStatusMutex.RUnlock()
	return fake.updateStatusArgsForCall[i].arg1
}

func (fake *FakeNamespace) UpdateStatusReturns(result1 *v1.Namespace, result2 error) {
...
func (fake *FakeNamespace) Get(name string) (*v1.Namespace, error) {
	fake.getMutex.Lock()
...
func (fake *FakeNamespace) GetReturns(result1 *v1.Namespace, result2 error) {
	fake.GetStub = nil
...
func (fake *FakeNamespace) List(opts api.ListOptions) (*v1.NamespaceList, error) {
	fake.listMutex.Lock()
...
func (fake *FakeNamespace) ListReturns(result1 *v1.NamespaceList, result2 error) {
	fake.ListStub = nil
...
func (fake *FakeNamespace) FinalizeArgsForCall(i int) *v1.Namespace {
	fake.finalizeMutex.RLock()
	defer fake.finalizeMutex.RUnlock()
	return fake.finalizeArgsForCall[i].item
}

func (fake *FakeNamespace) FinalizeReturns(result1 *v1.Namespace, result2 error) {
